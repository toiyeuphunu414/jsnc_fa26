...
const info1 = "Ten: " + name1 + " Tuoi: " +age1 + " Major: " + major1;
console.log(info1);
...
const mystudent1 = `Mã sinh viên: ${student1.idd} Họ và tên: ${student1.name1} Tuổi: ${student1.age1} Ngành: ${student1.major1}`;
